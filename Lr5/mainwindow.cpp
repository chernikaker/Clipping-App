    ...
    , ui(new Ui::MainWindow),scale(10)
{
    ...
    QWidget::connect(ui->dsb_Ymax,SIGNAL(valueChanged(double)), this, SLOT(on_spinBoxChanged()));
    QWidget::connect(ui->dsb_Ymin,SIGNAL(valueChanged(double)), this, SLOT(on_spinBoxChanged()));
    QWidget::connect(ui->dsb_Xmax,SIGNAL(valueChanged(double)), this, SLOT(on_spinBoxChanged()));
    QWidget::connect(ui->dsb_Xmin,SIGNAL(valueChanged(double)), this, SLOT(on_spinBoxChanged()));
...
void MainWindow::on_spinBoxChanged()
{
    if(ui->dsb_Xmin->value()>10)
    {
        QMessageBox::information(NULL,QObject::tr("Warning"),tr("Rectangle area is out of range."));
        ui->dsb_Xmin->setValue(10);
    }
    ...
    if(ui->dsb_Xmax->value()>10)
    {
        QMessageBox::information(NULL,QObject::tr("Warning"),tr("Rectangle area is out of range."));
        ui->dsb_Xmax->setValue(10);
    }
    ...
    if(ui->dsb_Ymin->value()>10)
    {
        QMessageBox::information(NULL,QObject::tr("Warning"),tr("Rectangle area is out of range."));
        ui->dsb_Ymin->setValue(10);
    }
    ...
    if(ui->dsb_Ymax->value()>10)
    {
        QMessageBox::information(NULL,QObject::tr("Warning"),tr("Rectangle area is out of range."));
        ui->dsb_Ymax->setValue(10);
    }
    ...
    if(ui->dsb_Xmin->value()>ui->dsb_Xmax->value())
    {
        QMessageBox::information(NULL,QObject::tr("Warning"),tr("Rectangle area is incorrect. Parameter is set to default."));
        ui->dsb_Xmin->setValue(-10);
        ui->dsb_Xmax->setValue(4);
         ui->dsb_Xmin->setValue(-4);
    }
    if(ui->dsb_Ymin->value()>ui->dsb_Ymax->value())
    {
        QMessageBox::information(NULL,QObject::tr("Warning"),tr("Rectangle area is incorrect.  Parameter is set to default."));
        ui->dsb_Ymin->setValue(-10);
        ui->dsb_Ymax->setValue(4);
         ui->dsb_Ymin->setValue(-4);
    }
...
void MainWindow::paintEvent(QPaintEvent *)
{
    ...
    QVector<QPair<QPointF,QPointF>> clipSegments = cutSegments(segments);
...
QVector<QPair<QPointF,QPointF>> MainWindow::cutSegments(QVector<QPair<QPointF,QPointF>> segments){
QVector<QPair<QPointF,QPointF>> clipSegments;
    for(int i=0; i < segments.size();i++){
        ...
        {
            clipSegments.push_back(segments[i]);
        }
    ...
    QFileDialog* dial = new QFileDialog(this);
      ...
      if (file.open(QIODevice::ReadOnly))
      {
          ...
          polygon.push_back(polygon[0]);
            ...
            line = in.readLine().split(" ");
          ui->dsb_Xmin->setValue(-10);
            ui->dsb_Xmax->setValue(line[2].toDouble());
          ui->dsb_Xmin->setValue(line[0].toDouble());
            ui->dsb_Ymin->setValue(-10);
            ui->dsb_Ymax->setValue(line[3].toDouble());
            ui->dsb_Ymin->setValue(line[1].toDouble());
